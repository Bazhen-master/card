// Клиент FusionBrain (Kandinsky). Оставлен как запасной поставщик: 07.09.2026
// основным стал GenAPI (см. lib/providers/genapi.js), Kandinsky оказался дорог
// при слабом качестве. Включается переменной IMAGE_PROVIDER=fusionbrain.
// Ключи выдаются в личном кабинете fusionbrain.ai.
...
// Значения по умолчанию — 3:4, пропорция готовых колод в каталоге.
...
export const fusionbrain = {
  id: "fusionbrain",
  title: "FusionBrain (Kandinsky)",
  keysUrl: "https://fusionbrain.ai/keys/",
  styles: STYLES,
  missingEnv,
  generateImage,
};
