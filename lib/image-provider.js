...
//
// Стороны подобраны так, чтобы картинка не переваливала за миллион пикселей:
// GenAPI берёт за Flux Schnell 0,50 ₽ до этой границы и 1 ₽ после неё. Замеры
// настоящими списаниями 10.09.2026: 768×1024 и 1024×768 — 0,50 ₽, 1024×1024 —
// 1 ₽, 960×960 — снова 0,50 ₽. Поэтому квадрат рисуется в 960 пикселей: на
// глаз это тот же квадрат (превью в галерее всё равно 700 px), а обходится он
// вдвое дешевле. Прежде чем увеличивать любую сторону, проверить цену
// списанием — граница дороже, чем выглядит.
