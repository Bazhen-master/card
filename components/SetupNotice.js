// Показывается, пока не заданы ключи: сайт остаётся рабочим, а страница
// называет конкретные незаданные переменные — так сразу видно, что именно
// не доехало до хостинга.
export default function SetupNotice({
  missing = [],
  title = "База данных ещё не подключена",
  children,
}) {
  return (
